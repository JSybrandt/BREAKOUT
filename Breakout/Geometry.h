...
public:
	...
	virtual void init(ID3D10Device* device, std::string objFile, LPCWSTR texFile = L".\\textures\\grey.dds", bool comp = false, LPCWSTR specFile = L".\\textures\\defaultspec.dds");
